plot4 <- function(){
  ...
  dt$Global_reactive_power <- as.double(as.character(dt$Global_reactive_power))
  dt$Voltage <- as.double(as.character(dt$Voltage))
  ...
  #plot2
  plot(dt$DateTime, dt$Voltage, col="black", 
  ...
  #plot4
  plot(dt$DateTime, dt$Global_reactive_power, col="black", 
